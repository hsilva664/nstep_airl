...
def main(exp_name=None, fusion=False, visible_gpus='0', discount=0.99):
    ...
    irl_model = AIRLStateAction(discount=discount, env_spec=env.spec, expert_trajs=experts)
    ...
    with rllab_logdir(algo=algo, dirname='data/half_cheetah_airl_no_disent'):
